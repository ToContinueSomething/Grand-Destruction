...
namespace Mkey
{
    public class LevelMap : MonoBehaviour, ILevelMap, ISavedProgress

    {
        ...
        public static int
            currentLevel =
                1; // set from this script by clicking on button. Use this variable to load appropriate level.

        public static int topPassedLevel = 32; // set from game MapController.topPassedLevel = 2; 
        ...
        {
            topPassedLevel =  progress.LevelMapData.GetCompletedLevelCount();
        }
